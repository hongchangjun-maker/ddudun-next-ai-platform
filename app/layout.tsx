...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = "뚜둔 NEXT | 상담과 활동을 잇는 AI 워크스페이스";
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      locale: "ko_KR",
      images: [{ url: `${origin}/og-social.png`, width: 1200, height: 630, alt: "뚜둔 NEXT 서비스 소개" }],
    },
    twitter: { card: "summary_large_image", title, description, images: [`${origin}/og-social.png`] },
  };
}
